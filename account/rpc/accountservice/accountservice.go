...
type (
	AccountService interface {
		...
		ChangeEmail(ctx context.Context, in *EmailChangeRequest) (*AccountEmpty, error)
		...
		TrackEvent(ctx context.Context, in *TrackEventRequest) (*AccountEmpty, error)
...
func (m *defaultAccountService) ChangeEmail(ctx context.Context, in *EmailChangeRequest) (*AccountEmpty, error) {
	var request account.EmailChangeRequest
	bts, err := jsonx.Marshal(in)
	if err != nil {
		return nil, errJsonConvert
...
func (m *defaultAccountService) TrackEvent(ctx context.Context, in *TrackEventRequest) (*AccountEmpty, error) {
	var request account.TrackEventRequest
	bts, err := jsonx.Marshal(in)
	if err != nil {
		return nil, errJsonConvert
	}
