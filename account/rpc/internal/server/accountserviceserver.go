...
func (s *AccountServiceServer) ChangeEmail(ctx context.Context, in *account.EmailComfirmation) (*account.AccountEmpty, error) {
...
func (s *AccountServiceServer) TrackEvent(ctx context.Context, in *account.TrackEventReqeust) (*account.AccountEmpty, error) {
